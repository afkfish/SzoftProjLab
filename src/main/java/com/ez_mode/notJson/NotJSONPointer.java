...
public class NotJSONPointer {
  ...
  public static class Builder {
    ...
    public NotJSONPointer build() {
      return new NotJSONPointer(this.refTokens);
    }
   ...
   */
  public NotJSONPointer(final String pointer) {
    if (pointer == null) {
   ...
   * @throws NotJSONPointerException if an error occurs during evaluation
   */
  public Object queryFrom(Object document) throws NotJSONPointerException {
    if (this.refTokens.isEmpty()) {
      return document;
    }
    Object current = document;
    for (String token : this.refTokens) {
      if (current instanceof NotJSONObject) {
        current = ((NotJSONObject) current).opt(unescape(token));
  ...
  private static Object readByIndexToken(Object current, String indexToken) throws NotJSONPointerException {
    try {
      ...
      try {
        ...
        throw new NotJSONPointerException("Error reading value at index position " + index, e);
      }
    } catch (NumberFormatException e) {
      throw new NotJSONPointerException(format("%s is not an array index", indexToken), e);
    }
  }
