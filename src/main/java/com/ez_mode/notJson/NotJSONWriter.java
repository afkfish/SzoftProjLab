 ...
 * <p>
 * This can sometimes be easier than using a NotJSONObject to build a string.
 * @author JSON.org
 * @version 2016-08-08
 */
public class NotJSONWriter {
   ...
   * @return this
   * @throws NotJSONException If the nesting is too deep, or if the object is
  ...
  private NotJSONWriter end(char m, char c) throws NotJSONException {
    if (this.mode != m) {
      throw new NotJSONException(m == 'a'
              ? "Misplaced endArray."
              : "Misplaced endObject.");
    }
    this.pop(m);
   ...
   * @return this
   * @throws NotJSONException If the key is out of place. For example, keys
   ...
   * NotJSONObject will be made from it and its toNotJSONString method will be
  ...
  public static String valueToString(Object value) throws NotJSONException {
    ...
    if (value instanceof Boolean || value instanceof NotJSONObject
   ...
   *   String, NotJSONObject, or NotJSONArray, or an object that implements NotJSONString.
   * @return this
   * @throws NotJSONException If the value is out of sequence.
   */
