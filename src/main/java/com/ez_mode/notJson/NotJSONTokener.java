...
public class NotJSONTokener {
   ...
   * @throws NotJSONException Thrown if trying to step back more than 1 step
   ...
   * @throws NotJSONException thrown if there is an error stepping forward
   ...
   * @return   A string.
   * @throws NotJSONException Thrown if there is an error while searching
   *  for the delimiter
   */
